...
A an example of a a tool list can be found in [here](https://github.com/ARTbio/galaxy-kickstart/blob/master/extra-files/metavisitor/metavisitor_tool_list.yml)
```
tools:
