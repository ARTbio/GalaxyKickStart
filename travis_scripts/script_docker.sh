...
echo "sleeping 90s, moving data to /export directory zzzzzz"
sleep 90s
docker logs $CID1
...
CID3=`docker run -d --privileged=true -p 8181:80 -e NAT_MASQUERADE=true -v /export2:/export metavisitor` && sleep 120s
docker logs $CID3
