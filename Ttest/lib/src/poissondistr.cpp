...
double poissondistribution(int k, double m)
{
    ...
    ap::ap_error::make_assertion(k>=0&&ap::fp_greater(m,0), "Domain error in PoissonDistribution");
...
double poissoncdistribution(int k, double m)
{
    ...
    ap::ap_error::make_assertion(k>=0&&ap::fp_greater(m,0), "Domain error in PoissonDistributionC");
...
double invpoissondistribution(int k, double y)
{
    ...
    ap::ap_error::make_assertion(k>=0&&ap::fp_greater_eq(y,0)&&ap::fp_less(y,1), "Domain error in InvPoissonDistribution");
