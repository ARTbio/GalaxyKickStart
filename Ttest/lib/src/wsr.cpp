...
static double w5(double s);
static double w6(double s);
static double w7(double s);
static double w8(double s);
static double w9(double s);
static double w10(double s);
static double w11(double s);
static double w12(double s);
static double w13(double s);
static double w14(double s);
static double w15(double s);
static double w16(double s);
static double w17(double s);
static double w18(double s);
static double w19(double s);
static double w20(double s);
static double w21(double s);
static double w22(double s);
static double w23(double s);
static double w24(double s);
static double w25(double s);
static double w26(double s);
static double w27(double s);
static double w28(double s);
static double w29(double s);
static double w30(double s);
static double w40(double s);
static double w60(double s);
static double w120(double s);
static double w200(double s);
static double wsigma(double s, int n);
     ...
     double& righttail)
{
    ...
    sigma = sqrt(double(ns*(ns+1)*(2*ns+1))/double(24));
    s = (w-mu)/sigma;
    ...
    lefttail = ap::maxreal(p, 1.0E-4);
    righttail = ap::maxreal(mp, 1.0E-4);
}
...
static double w5(double s)
{
    ...
    w = ap::round(-3.708099e+00*s+7.500000e+00);
    if( w>=7 )
    {
        r = -6.931e-01;
    }
...
static double w6(double s)
{
    ...
    w = ap::round(-4.769696e+00*s+1.050000e+01);
    if( w>=10 )
    {
        r = -6.931e-01;
    }
...
static double w7(double s)
{
    ...
    w = ap::round(-5.916080e+00*s+1.400000e+01);
    if( w>=14 )
    {
        r = -6.325e-01;
    }
...
static double w8(double s)
{
    ...
    w = ap::round(-7.141428e+00*s+1.800000e+01);
    if( w>=18 )
    {
        r = -6.399e-01;
    }
...
static double w9(double s)
{
    ...
    w = ap::round(-8.440972e+00*s+2.250000e+01);
    if( w>=22 )
    {
        r = -6.931e-01;
    }
...
static double w10(double s)
{
    ...
    w = ap::round(-9.810708e+00*s+2.750000e+01);
    if( w>=27 )
    {
        r = -6.931e-01;
    }
...
static double w11(double s)
{
    ...
    w = ap::round(-1.124722e+01*s+3.300000e+01);
    if( w>=33 )
    {
        r = -6.595e-01;
    }
...
static double w12(double s)
{
    ...
    w = ap::round(-1.274755e+01*s+3.900000e+01);
    if( w>=39 )
    {
        r = -6.633e-01;
    }
...
static double w13(double s)
{
    ...
    w = ap::round(-1.430909e+01*s+4.550000e+01);
    if( w>=45 )
    {
        r = -6.931e-01;
    }
...
static double w14(double s)
{
    ...
    w = ap::round(-1.592953e+01*s+5.250000e+01);
    if( w>=52 )
    {
        r = -6.931e-01;
    }
...
static double w15(double s)
{
    ...
    w = ap::round(-1.760682e+01*s+6.000000e+01);
    if( w>=60 )
    {
        r = -6.714e-01;
    }
...
static double w16(double s)
{
    ...
    w = ap::round(-1.933908e+01*s+6.800000e+01);
    if( w>=68 )
    {
        r = -6.733e-01;
    }
...
static double w17(double s)
{
    ...
    w = ap::round(-2.112463e+01*s+7.650000e+01);
    if( w>=76 )
    {
        r = -6.931e-01;
    }
...
static double w18(double s)
{
    ...
    w = ap::round(-2.296193e+01*s+8.550000e+01);
    if( w>=85 )
    {
        r = -6.931e-01;
    }
...
static double w19(double s)
{
    ...
    w = ap::round(-2.484955e+01*s+9.500000e+01);
    if( w>=95 )
    {
        r = -6.776e-01;
    }
...
static double w20(double s)
{
    ...
    w = ap::round(-2.678619e+01*s+1.050000e+02);
    if( w>=105 )
    {
        r = -6.787e-01;
    }
...
static double w21(double s)
{
    ...
    w = ap::round(-2.877064e+01*s+1.155000e+02);
    if( w>=115 )
    {
        r = -6.931e-01;
    }
...
static double w22(double s)
{
    ...
    w = ap::round(-3.080179e+01*s+1.265000e+02);
    if( w>=126 )
    {
        r = -6.931e-01;
    }
...
static double w23(double s)
{
    ...
    w = ap::round(-3.287856e+01*s+1.380000e+02);
    if( w>=138 )
    {
        r = -6.813e-01;
    }
...
static double w24(double s)
{
    ...
    w = ap::round(-3.500000e+01*s+1.500000e+02);
    if( w>=150 )
    {
        r = -6.820e-01;
    }
...
static double w25(double s)
{
    ...
    result = 0;
    x = ap::minreal(2*(s-0.000000e+00)/4.000000e+00-1, 1.0);
    tj = 1;
    tj1 = x;
