...
If you want to install galaxy tools, go to the directory where you cloned this repository, change the [targethost], [targetuser] for the IP and user of the target machine respectively, and execute: 
```
